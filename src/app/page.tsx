    ...
    <div className="flex min-h-screen items-center justify-center bg-slate-50 font-sans">
      <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-between bg-white px-16 py-32 sm:items-start">
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          <a
            className="flex h-12 w-full items-center justify-center gap-2 rounded-full bg-foreground px-5 text-background transition-colors hover:bg-slate-700 md:w-[158px]"
          ...
          <a
            className="flex h-12 w-full items-center justify-center rounded-full border border-solid border-slate-300 px-5 text-slate-900 transition-colors hover:border-slate-400 hover:bg-slate-100 md:w-[158px]"
